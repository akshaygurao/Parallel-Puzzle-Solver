 ...
 */
public abstract class SkippingPuzzleSolver extends PuzzleSolver
{
    ...
    public SkippingPuzzleSolver(Puzzle puzzle)
    {
        super(puzzle);
    }
    ...
    public Choice follow(Position at, Direction dir) throws SolutionFound
    {
        ...
        do
        {
            if (at.equals(puzzle.getEnd())) throw new SolutionFound(at, go_to.reverse());
            if (at.equals(puzzle.getStart())) throw new SolutionFound(at, go_to.reverse());
            choices = puzzle.getMoves(at);
    ...
    public void markPath(List<Direction> path, int color)
    {
        try
        {
            Choice choice = firstChoice(puzzle.getStart());
    ...
    public List<Direction> pathToFullPath(List<Direction> path)
    {
        ...
        Position curr = puzzle.getStart();
        Direction go_to = null, came_from = null;
        while (!curr.equals(puzzle.getEnd()))
        {
            LinkedList<Direction> moves = puzzle.getMoves(curr);
